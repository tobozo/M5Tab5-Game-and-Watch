...
/* refresh rate (Hz) */
#define GW_REFRESH_RATE 64 // must be a divisor of GW_SYS_FREQ e.g. power of 2

/* System clock = Audio clock = 32768Hz */
#define GW_SYS_FREQ 32768U
#define GW_AUDIO_FREQ GW_SYS_FREQ

#define GW_AUDIO_BUFFER_LENGTH (GW_AUDIO_FREQ / GW_REFRESH_RATE)*2

/* emulated system : number of clock cycles per loop */
#define GW_SYSTEM_CYCLES (GW_SYS_FREQ / GW_REFRESH_RATE)
...
#define GW_BUTTON_LEFT 1           //   1 0x01
#define GW_BUTTON_UP (1 << 1)      //   2 0x02
#define GW_BUTTON_RIGHT (1 << 2)   //   4 0x04
#define GW_BUTTON_DOWN (1 << 3)    //   8 0x08
#define GW_BUTTON_A (1 << 4)       //  16 0x10
#define GW_BUTTON_B (1 << 5)       //  32 0x20
#define GW_BUTTON_TIME (1 << 6)    //  64 0x40
#define GW_BUTTON_GAME (1 << 7)    // 128 0x80
